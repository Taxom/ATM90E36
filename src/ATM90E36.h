...
#define UangleC 0xFF		// C Voltage Phase Angle
	...
	public:
		...
		double GetVoltPhaseA();
		double GetVoltPhaseB();
		double GetVoltPhaseC();		
		...
		double GetImportVarh();
		double GetExportVarh();
		
		double GetImportAenergy();
		double GetImportBenergy();
		double GetImportCenergy();
		
		double GetExportAenergy();
		double GetExportBenergy();
		double GetExportCenergy();
